...
@section('styles')
<link rel="stylesheet" href="/css/default_main.css">
@endsection
@section('content')
   <!-- Main Content -->
   <div class="main">
...
<div class="song-playback-bar">
    <div class="song-info">
        <div class="song-info-cover">
            <img src="pic/peaches.jpeg" alt="Peaches_Kai">
        </div>
        <div class="song-details">
            <div class="song-title">Peaches</div>
            <div class="artist-name">Kai</div>
        </div>
    </div>
    ...
    <div class="playback-controls-container">
        <div class="playback-controls">
            ...
            <button class="prev-track-btn"><i class="fa fa-backward" aria-hidden="true"></i></button>
            ...
            <button class="next-track-btn"><i class="fa fa-step-forward" aria-hidden="true"></i></button>
        ...
        <div class="song-progress-bar">
            ...
            <span id="duration" class="time-display">3:00</span>
        </div>
    </div>
...
<audio id="audio-player">
    <source id="audio-source" src="{{ asset('music/peaches.mp3') }}" type="audio/mpeg">
</audio>
@endsection
