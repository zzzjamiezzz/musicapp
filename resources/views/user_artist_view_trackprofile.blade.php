...
@section('styles')
<link rel="stylesheet" href="css/user_artist_view_trackprofile.css">
@endsection
@section('content')
   <!-- Main Content -->
   <div class="main">
    ...
    <div class="content-container">
        ...
        <div class="card">
            ...
            <div class="album">Lose My Breath, 2024</div>
            <div class="like_song"><u>Charlie Puth</u> has liked this song.</div>
            </div>
        </div>
